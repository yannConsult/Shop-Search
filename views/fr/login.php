    ...
    <div class="row p-4">
        <div class="d-md-12 col-md-6 text-center p-md-5 p-lg-5 text-left">
            <div class="d-flex flex-column justify-content-center align-items-center">
                <h1 class="h1-responsive color-primary-dark mb-5 text-uppercase">Veuillez-vous identifiez</h1>
        ...
        <div class="d-md-12 col-md-6 py-md-5 py-lg-5">
            <div class="card w-75 mx-auto">
                <div class="py-3 gradient-primary-color-dark text-center">
                    <h3 class="h3-responsive text-white">SE CONNECTER</h3>
                </div>
                <div class="row">
                    <div class="col-12 p-lg-5 p-md-4">
                        <form action="../../../back-end/fr/c_login.php" method="POST" class="py-md-4 py-lg-4 p-4">
                        ...
                        <div class="container">
                            <div class="row my-3">
                                <div class="col-12 text-center">
                                    <p class="h6 font-weight-light">Pas encore un client? <a href="./contact.php"
                                                                                          class="underliner accent-color-dark">Souscrivez à nos produits et services</a></p>
                                </div>
                            </div>
                        </div>
