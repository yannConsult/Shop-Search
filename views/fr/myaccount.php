    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="md-form" action="../../../back-end/fr/c_profil.php" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="md-form mb-5">
                                        ...
                                        <label class="m-0" data-error="wrong" data-success="right" for="customLogo">
                                            Logo</label>
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="customLogo" name="customLogo"
                                                   aria-describedby="inputGroupFileAddon01">
                                            <label class="custom-file-label" id="choose-file" for="customLogo">Choisir le fichier</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="my-2 d-flex flex-column">
                    <h3 class="h3-responsive primary-color-dark">Profile</h3>
            ...
            if ($customer != null) {
                    ...
                    <div class="position-relative">
                        ...
                        if ($customer['Picture'] == NULL) {
                            ...
                            <img alt="user picture profil" class="img-fluid"
                                 src="data:image/png;charset=utf8;base64,<?php echo base64_encode($customer['Picture']) ?>"/>
                            <?php
                        }
                        ?>
                    </div>
                ...
                <div class="col-lg-9 my-auto">
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <a href="#exampleModal" id="edit-profil-btn">
                ...
                <div>
                    <div class="table-responsive">
                        <table class="table cart-table cart_prdct_table text-center">
                            <thead>
                            <tr>
                                <th class="cpt_img text-uppercase bg-primary-color-dark text-white">Numéro de commande</th>
                                <th class="cpt_desc text-uppercase bg-primary-color-dark text-white">Date de commande</th>
                                <th class="cpt_date text-uppercase bg-primary-color-dark text-white">Nom du produit</th>
                                <th class="cpt_func text-uppercase bg-primary-color-dark text-white">LE MONTANT PAYÉ</th>
                                <th class="cpt_sub_func text-uppercase bg-primary-color-dark text-white">MONTANT À PAYER</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php
        ...
        <div class="container">
            <div class="row mb-4">
                <div class="col-lg-6 text-left">
                    <h4 class="primary-color-dark text-uppercase"> MONTANT TOTAL DÛ</h4>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-12">
                        <div class="my-4 d-flex flex-column">
                            <h3 class="h3-responsive primary-color-dark text-capitalize">Rapport des problèmes</h3>
                    ...
                    <div class="card shadow">
                        <div class="row py-3">
                            ...
                            if ($reports != null) {
                                                    ...
                                                    <div class="d-inline-flex justify-content-between">
                                                        ...
                                                        <div class="font-weight-light font-italic primary-color-dark">
                                                            ...
                                                            <?php if ($issues['impact'] == 3) { ?>
                                                                <span class="text-danger font-weight-bold h6">Elevée</span>
                                                            <?php } else if ($issues['impact'] == 1) { ?>
                                                                <span class="text-primary font-weight-bold h6">Faible</span>
                                                            <?php } else if ($issues['impact'] == 2) { ?>
                                                                <span class="text-warning font-weight-bold h6">Moyen</span>
                                                            <?php } ?>
                                                        </div>
                                ...
                                ?>
                                <div class="col-lg-12 ">
                                    <p class="h5">Aucun enregistrement trouvé.</p>
                                </div>
                                <?php
                            }
                            ?>
                        ...
                        <div class="row mx-auto text-center">
                            ...
                            <div class="col-lg-12 ">
                                <a href="./issues.php"
                                   class="btn bg-primary-color text-white mb-3 waves-effect waves-light"
                                >Repporter les nouveaux problèmes</a>
                            </div>
                        </div>
                ...
                <div class="row mt-4">
                    <div class="col-lg-12">
                        <h5 class="h3-responsive primary-color-dark text-capitalize">légende du statut :</h5>
                        <div class="d-inline-flex justify-content-start">
                            <div class="status-circle-open mx-auto"></div>
                            <div class="primary-color">
                                <p class="text-capitalize ml-2">Ouvert</p>
                            </div>
                        </div>
                        <div class="d-inline-flex justify-content-start ml-2">
                            <div class="status-circle-inprogress mx-auto"></div>
                            <div class="primary-color">
                                <p class="text-capitalize ml-2">En cours</p>
                            </div>
                        </div>
                        <div class="d-inline-flex justify-content-start ml-2">
                            <div class="status-circle-blocked mx-auto"></div>
                            <div class="primary-color">
                                <p class="text-capitalize ml-2">Bloqué</p>
                            </div>
                        </div>
                        <div class="d-inline-flex justify-content-start ml-2">
                            <div class="status-circle-readyfortest mx-auto"></div>
                            <div class="primary-color">
                                <p class="text-capitalize ml-2">Prêt pour approbation</p>
                            </div>
                        </div>
                        <!-- <div class="d-inline-flex justify-content-start ml-2">
