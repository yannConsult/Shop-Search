...
<head>
    ...
    <title>SMART Consulting - S'enregistrer</title>
</head>
<body>
    ...
    <div class="row p-4">
        <div class="d-md-12 col-md-6 text-center p-md-5 p-lg-5 text-left">
            <div class="d-flex flex-column justify-content-center align-items-center">
                <h1 class="h1-responsive color-primary-dark mb-5 text-uppercase">Rejoingner notre communauté</h1>
        ...
        <div class="d-md-12 col-md-6 py-md-5 py-lg-5">
            <div class="card w-75 mx-auto">
                <div class="py-3 gradient-primary-color-dark text-center">
                    <h3 class="h3-responsive text-white">S'ENREGISTRER</h3>
                </div>
                <div class="row">
                    <div class="col-12 p-lg-5 p-md-4">
                        <div class="p-3 p-md-0">
                                    ...
                                    <div class="col-md-6 my-2 my-md-0">
                                        <div class="form-outline mb-lg-5 mb-md-3">
                                            ...
                                            <label class="form-label" for="name"><i
                                                        class="fas fa-user mr-2 color-primary-dark"></i>Nom</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 my-2 my-md-0">
                                        <div class="form-outline mb-lg-5 mb-md-3">
                                            ...
                                            <label class="form-label" for="tel"><i
                                                        class="fas fa-mobile mr-2 color-primary-dark"></i>Numéro de téléphone
                                                </label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6 my-2 my-md-0">
                                        <div class="form-outline mb-lg-5 mb-md-3">
                                            ...
                                            <label class="form-label" for="password"><i
                                                        class="fas fa-lock mr-2 color-primary-dark"></i>Mot de passe</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 my-2 my-md-0">
                                        <div class="form-outline mb-lg-5 mb-md-3">
                                            ...
                                            <label class="form-label" for="confirm_password"><i
                                                        class="fas fa-lock mr-2 color-primary-dark"></i>Confirmer le mot de passe</label>
                                        </div>
                                    </div>
                            ...
                            <div class="container">
                                <div class="row my-3">
                                    <div class="col-12 text-center">
                                        <p class="h6 font-weight-light">Vous avez déjà un compte ? <a href="./login.php"
                                                                                                 class="underliner accent-color-dark">Connectez-vous</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
