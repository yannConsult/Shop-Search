        ...
        <div class="row mx-1 d-flex justify-content-between ">
            <div class="col-md-4 col-lg-5">
                <div class="d-flex flex-column justify-content-around align-items-center py-3 py-md-5">
                    <div class="primary-color p-4 text-center">
                        <h3 class="h3-responsive">We are listening to your request</h3>
                    </div>
            ...
            <div class="col-md-8 col-lg-5">
                <div class="d-flex flex-column justify-content-center align-items-center py-md-5">
                    <form class="w-100" action="../../../back-end/en/c_request.php" method="POST"
                        ...
                        <div class="py-3 ">
                            <div class="form-outline">
                                ...
                                <label class="form-label" for="forName"> <i
                                            class="fas fa-user mr-2 color-primary-dark"></i>Your name <span
                        ...
                        <div class="py-3 ">
                            <div class="form-outline">
                                ...
                                <label class="form-label" for="forTel">
                                    <i class="fas fa-mobile mr-2 color-primary-dark"></i>Phone Number <span
                                            class="text-danger">*</span></label>
                            </div>
                        </div>
                        ...
                        <div class="py-3 w-100">
                            <div class="form-outline">
                                ...
                                <label class="form-label" for="forAddress"><i
                                            class="fas fa-address-card mr-2 color-primary-dark"></i>Address <span
                                            class="text-danger">*</span></label>
                            </div>
                        </div>
                        <div class="py-3 w-100">
                            <div class="form-outline">
                                <label class="form-label" for="forBusinessType"> <i
                                            class="fab fa-servicestack mr-2 primary-color"></i>Business Type <span
                                            class="text-danger">*</span></label>
                        ...
                        <div class="py-3 w-100 ">
                            <div class="form-outline">
                                <label class="form-label" for="selectType"> <i
                                            class="fab fa-servicestack mr-2 primary-color"></i> Request Type <span
                                            class="text-danger">*</span></label>
                                <select class="primary-color form-select" id="selectType" name="selectType" required>
                                    <option class="primary-color" id="select-first-choice" disabled value="0"
                                            selected></option>
                                    <option class="primary-color" value="Products">Products</option>
                        ...
                        <div class="py-3 w-100 ">
                            <div class="form-outline" id="formItem">
                                <label class="form-label" for="selectItem"><i
                                            class="fas fa-tasks mr-2 primary-color"></i>Requested Item <span
                                            class="text-danger">*</span></label>
                                <div>
                        ...
                        <div class="py-3 w-100">
                            <div class="form-file form-file-lg">
                                ...
                                <label class="form-file-label" for="customFile">
                                    <span class="form-file-text" id="choose-file">Upload the requierement doc</span>
                        ...
                        <div class="py-3 w-100 ">
                            <div class="form-outline">
                                <textarea class="form-control input-value" id="textAreaForm" name="textAreaForm"
                                          rows="2"
                                          required></textarea>
                                <label class="form-label txt" for="textAreaForm">Tell us what you need for <span
                                            class="text-danger">*</span></label>
                            </div>

                        </div>

                        <span class="text-danger">* Require fields</span>
