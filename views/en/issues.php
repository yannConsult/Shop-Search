...
<head>
    ...
    <title>SMART Consulting - Report Issues</title>
</head>
        ...
        <div class="row mx-1 d-flex justify-content-between ">
            <div class="col-md-4 col-lg-5">
                <div class="d-flex flex-column justify-content-around align-items-center py-3 py-md-5">
                    <div class="primary-color p-4 text-center">
                        <h3 class="h3-responsive">ISSUES FORM</h3>
                    </div>
            ...
            <div class="col-md-8 col-lg-5">
                <div class="d-flex flex-column justify-content-center align-items-center py-md-5">
                    <form class="w-100" action="../../../back-end/en/c_issues.php" method="POST"
                          enctype="multipart/form-data">

                        <div class="py-3 w-100">
                            <div class="form-outline">
                                <label class="form-label" for="forRelatedTo"> <i
                                            class="fab fa-servicestack mr-2 primary-color"></i>Related To <span
                        ...
                        <div class="py-3 w-100 ">
                            <div class="form-outline">
                                <label class="form-label" for="forPriority"> <i
                                            class="fab fa-servicestack mr-2 primary-color"></i> Impact <span
                                            class="text-danger">*</span></label>
                                <select class="primary-color form-select" id="forPriority" name="forPriority" required>
                                    <option class="primary-color" id="select-first-choice" disabled
                                            selected></option>
                                    <option class="primary-color" value="1">Low</option>
                                    <option class="primary-color" value="2">Medium</option>
                                    <option class="primary-color" value="3">Hight</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="py-3 ">
                            <div class="form-outline">
                                 <textarea class="form-control input-value" id="forDescription" name="forDescription"
                                           rows="2"
                                           required></textarea>
                                <label class="form-label txt" for="forDescription">Tell us about your problem <span
                                            class="text-danger">*</span></label>
                            </div>
                        </div>
                        ...
                        <div class="py-3 w-100">
                            <div class="form-file form-file-lg">
                                ...
                                <label class="form-file-label" for="customFile">
                                    <span class="form-file-text" id="choose-file">Upload the description document</span>
